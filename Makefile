...
compress: $(COMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES)
	$(CC) -c $(COMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES) -lpng
	$(CC) -o compress $(COMPRESS_OBJECT_FILES) $(SHARED_OBJECT_FILES) -lpng

decompress: $(DECOMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES)
	$(CC) -c $(DECOMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES) -lpng
	$(CC) -o decompress $(DECOMPRESS_OBJECT_FILES) $(SHARED_OBJECT_FILES) -lpng

compress-sane: $(COMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES)
	$(CC) -c $(DEBUG_FLAGS) $(COMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES) -lpng
	$(CC) -o compress $(DEBUG_FLAGS) $(COMPRESS_OBJECT_FILES) $(SHARED_OBJECT_FILES) -lpng

decompress-sane: $(DECOMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES)
	$(CC) -c $(DEBUG_FLAGS) $(DECOMPRESS_SOURCE_FILES) $(SHARED_SOURCE_FILES) -lpng
	$(CC) -o decompress $(DEBUG_FLAGS) $(DECOMPRESS_OBJECT_FILES) $(SHARED_OBJECT_FILES) -lpng
